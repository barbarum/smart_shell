...
curl -fsSL https://raw.githubusercontent.com/barbarum/smart_shell/master/tools/quick_install.sh | bash
```
...
curl -fsSL https://raw.githubusercontent.com/barbarum/smart_shell/master/tools/install.sh | bash
```
...
curl -fsSL https://raw.githubusercontent.com/barbarum/smart_shell/master/tools/install.sh -o install.sh
